  ...
  observe({allowQueryChanges = false, name = null} = {}) {
    return Rx.Observable.create((observer) => {
      ...
      if (allowQueryChanges) {
        unsubscribe = this._database._subscriptionPool.addPrivateSubscription(name, this, observer.onNext);
      } else {
        unsubscribe = this._database._subscriptionPool.add(this, observer.onNext);
      }
